...
export default function SkillCard({ icon = "react", skillName, description }) {
  return (
    <div className="flex relative justify-center">
      ...
      <div className="flex flex-col items-center w-60 h-40 py-12 px-8 rounded-md shadow-lg bg-black bg-opacity-800  hover:shadow-xl hover:bg-gray-800 cursor-pointer ">
